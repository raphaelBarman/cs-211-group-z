...
My2DPoint projectPoint(My3DPoint eye, My3DPoint p) {
  My3DPoint transform = new My3DPoint(p.x - eye.x, p.y - eye.y, p.z-eye.z);
  float coeff = (-eye.z)/(p.z-eye.z);
  return new My2DPoint(transform.x * coeff, transform.y * coeff);
}
...
My2DBox projectBox (My3DPoint eye, My3DBox box) {
  int points = box.p.length;
  My2DPoint[] s = new My2DPoint[points];
